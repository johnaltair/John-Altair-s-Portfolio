...
<div class="portfolio-boxes">
    ...
    <a title="Eyedentity" href="index.php?mod=portfolio&sub=eyedentity" class="portfolio-box">
        <img alt="Eyedentity" src="images/portfolio/thumbnails/eyedentity.png">
        <span>Eyedentity</span>
    </a>
    <a title="Gneus X" href="index.php?mod=portfolio&sub=gneus-x" class="portfolio-box">
    ...
    <a title="Manpower System" href="index.php?mod=portfolio&sub=manpower-system" class="portfolio-box">
    ...
    <a title="PaciaLand" href="index.php?mod=portfolio&sub=pacialand" class="portfolio-box">
        <img alt="PaciaLand" src="images/portfolio/thumbnails/pacialand.png">
        <span>PaciaLand</span>
    </a>
    <a title="Paper Head" href="index.php?mod=portfolio&sub=paper-head" class="portfolio-box">
        <img alt="Paper Head" src="images/portfolio/thumbnails/paper-head.png">
        <span>Paper Head</span>
    </a>
    <a title="Phyco" href="index.php?mod=portfolio&sub=phyco" class="portfolio-box">
        <img alt="Phyco" src="images/portfolio/thumbnails/phyco.png">
        <span>Phyco</span>
    </a>
    <a title="Piastra Italiano" href="index.php?mod=portfolio&sub=piastra-italiano" class="portfolio-box">
    ...
    <a title="Portrait I" href="index.php?mod=portfolio&sub=portrait-i" class="portfolio-box">
        <img alt="Portrait I" src="images/portfolio/thumbnails/portrait-i.png">
        <span>Portrait I</span>
    </a>
    <a title="Portrait II" href="index.php?mod=portfolio&sub=portrait-ii" class="portfolio-box">
        <img alt="Portrait II" src="images/portfolio/thumbnails/portrait-ii.png">
        <span>Portrait II</span>
    </a>
    <a title="Propaganda" href="index.php?mod=portfolio&sub=propaganda" class="portfolio-box">
        <img alt="Propaganda" src="images/portfolio/thumbnails/propaganda.png">
        <span>Propaganda</span>
    </a>
    <a title="Stark Coffee" href="index.php?mod=portfolio&sub=stark-coffee" class="portfolio-box">
        <img alt="Stark Coffee" src="images/portfolio/thumbnails/stark-coffee.png">
        <span>Stark Coffee</span>
    </a>
    <a title="Tienda del Palmera" href="index.php?mod=portfolio&sub=tienda-del-palmera" class="portfolio-box">
        <img alt="Tienda del Palmera" src="images/portfolio/thumbnails/tienda-del-palmera.png">
        <span>Tienda del Palmera</span>
    </a>
    <a title="True or False" href="index.php?mod=portfolio&sub=true-or-false" class="portfolio-box">
    ...
    <a title="Yeoleum Isle" href="index.php?mod=portfolio&sub=yeoleum-isle" class="portfolio-box">
        <img alt="Yeoleum Isle" src="images/portfolio/thumbnails/yeoleum-isle.png">
        <span>Yeoleum Isle</span>
    </a>
    <a title="Yingpei Design" href="index.php?mod=portfolio&sub=yingpei-design" class="portfolio-box">
        <img alt="Yingpei Design" src="images/portfolio/thumbnails/yingpei-design.png">
        <span>Yingpei Design</span>
    </a>
    <a title="Yingpei Photography" href="index.php?mod=portfolio&sub=yingpei-photography" class="portfolio-box">
